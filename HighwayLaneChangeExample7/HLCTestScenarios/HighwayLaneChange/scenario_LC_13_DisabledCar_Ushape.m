function [scenario, egoVehicle, roadCenters] = scenario_LC_13_DisabledCar_Ushape()
% scenario_LC_13_DisabledCar_Ushape creates a scenario that is
...
% vehicle initiates lane change to avoid collision with these vehicles. In
% this scenario ego vehicle performs a lane change to avoid collision with
% disabled vehicle in the left most lane.
%
...
waypoints = [62.6 51.9 0;
    ...
    392.3 26.2 0;
    395.3 15.4 0];
speed = [6;6;6;6;6;6;6;6;6;6;6;6;6;6;6];
