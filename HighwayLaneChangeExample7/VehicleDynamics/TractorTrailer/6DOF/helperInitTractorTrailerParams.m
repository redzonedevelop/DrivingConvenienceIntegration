function [tractorTrailerParameters,vehicleDimension] = helperInitTractorTrailerParams(vehicleType)
...
arguments
    vehicleType {mustBeMember(vehicleType,["Unreal Vehicle","RoadRunner Vehicle"])} = "Unreal Vehicle"
end
...
% While doing co-simulation with RoadRunner update the vehicle dimensions
% to match the dimesnion of the vehicles in the RR asset library
if vehicleType == "RoadRunner Vehicle"
    % Trailer Dimensions
    tractorTrailerParameters.TRA.FrontAxlePositionfromCG = 1.58;
    tractorTrailerParameters.TRA.RearAxlePositionfromCG = 4.1;
    tractorTrailerParameters.TRA.MiddleAxlePositionFromCG = 2.82;
    tractorTrailerParameters.TRA.HitchHeight = 0.43;
    tractorTrailerParameters.TRA.HitchDistance = 5.35;

    % Tractor Dimensions
    tractorTrailerParameters.VEH.FrontAxlePositionfromCG = 3.27;
    tractorTrailerParameters.VEH.RearAxlePositionfromCG = 3.5;
    tractorTrailerParameters.VEH.MiddleAxlePositionFromCG = 2.37;
    tractorTrailerParameters.VEH.HitchHeight = 0.43;
    tractorTrailerParameters.VEH.HitchDistance = 2.96;

    % Overall Dimensions
    vehicleDimension.TractorLength = 8.74;
    vehicleDimension.TrailerLength = 11.7;
    vehicleDimension.TrailerHitchToFront = 0.5;
    vehicleDimension.TractorEndToHitch = 0.9;
end